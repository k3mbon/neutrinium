...
import '../styles/TermsCondition.css'; // Import the CSS file

const TermsCondition = () => {

  useEffect(()=>{
    document.title='Terms & Condition | Neutrinium'
  })

  return (
    <div className="terms-condition-container">
      <h1 className="terms-condition-title">Terms & Conditions</h1>
      <p>
        These terms and conditions apply to the Neutrinium app (hereby referred to as "Application") for mobile devices
        that was created by k3mbon (hereby referred to as "Service Provider") as an Open Source service.
      </p>
      <p>
      ...
      <p>
        ...
        The Service Provider strongly advises against jailbreaking or rooting your phone, which involves removing software
      ...
      <p>
        Please note that the Application utilizes third-party services that have their own Terms and Conditions. Below are
        the links to the Terms and Conditions of the third-party service providers used by the Application:
      </p>
      <ul>
      ...
      <p>
        ...
        The Service Provider cannot be held responsible if the Application does not function at full capacity due to lack
      ...
      <p>
        ...
        (i.e., region or country) without disabling data roaming. If you are not the bill payer for the device on which you
        are using the application, they assume that you have obtained permission from the bill payer.
      </p>
      <p>
      ...
      <p>These terms and conditions are effective as of 2024-09-23</p>
      <h2>Contact Us</h2>
      <p>
        If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the
        Service Provider at <a href="mailto:angelus.tibiame@gmail.com">angelus.tibiame@gmail.com</a>.
      </p>
    </div>
  );
};
